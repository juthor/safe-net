...
<html lang="ko">
    ...
    <body>
        ...
        <section>
          ...
          ?>
            <form name="login_form" action="login_checkpai.php" method="post">
            ...
            <?php
              ...
              if ($_SESSION['id']=='gurohos')
              {
                echo "<script>location.href='gurohos.php';</script>";
              }
              else if ($_SESSION['id']=='ewhahos')
              {
                echo "<script>location.href='ewhahos.php';</script>";
              }
              else{
